...
7. `07-controlled-vocabularies.ttl` — curated shared SKOS schemes/concepts for year basis, salmon age, context, life phase, origin, methods, statistical modifiers, juvenile freshwater residence, juvenile nursery habitat, life-history type, and cycle line.
