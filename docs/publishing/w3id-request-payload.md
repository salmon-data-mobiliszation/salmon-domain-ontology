...
Status: registration merged in `perma-id/w3id.org` PR #5829; root/version routing update merged in PR #5873; term-path human-dereferencing update merged in PR #5881; path live
...
- Canonical shared-term paths such as `https://w3id.org/smn/Escapement` dereference to WIDOCO term anchors by default and remain content-negotiable for Turtle, RDF/XML, and JSON-LD.
- Secondary module, research/case-study build, and profile-root surfaces remain intentionally Turtle-first for now in the live resolver.
...
## Term dereferencing update status

The human-friendly dereferencing update for canonical shared-term IRIs is now merged and live:

- PR: <https://github.com/perma-id/w3id.org/pull/5881>
- Title: `smn: dereference term IRIs to WIDOCO anchors`
- Merged: `2026-03-27T18:35:58Z`
- Live verification: `docs/publishing/evidence/2026-05-13-w3id-term-dereference-live-check.md`
...
Local reference sources for the term resolver update:
...
### Current term-dereference checks
...
The root + SemVer routing follow-up and the term-path human-dereferencing follow-up are completed.
